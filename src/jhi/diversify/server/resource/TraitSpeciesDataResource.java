 ...
 */
public class TraitSpeciesDataResource extends ServerResource
{
	...
	public FileRepresentation getFile()
	{
		...
		File file = FileUtils.createTempFile("traits-speciesdata", ".tsv");
		...
		{
			ExportTraitDataSpecies procedure = new ExportTraitDataSpecies();

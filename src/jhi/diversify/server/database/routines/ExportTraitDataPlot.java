...
public class ExportTraitDataPlot extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 366911567;

    /**
     * The parameter <code>diversify.export_trait_data_plot.traitIds</code>.
     */
     ...
     */
    public ExportTraitDataPlot() {
        super("export_trait_data_plot", Diversify.DIVERSIFY);
